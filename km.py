# Code implemented by H. Ramaswamy, C. Scott, and A. Tewari, "Mixture Proportion Estimation via Kernel Embedding of Distributions," avXiv:1603.02501.
# Obtained from: http://web.eecs.umich.edu/~cscott/code/kernel_MPE.zip
# -*- coding: utf-8 -*-
"""
...
def get_distance_curve(
    ...
    for lambda_value in lambda_values:
        ...
        if distance_sqd >= 0:
            ...
            if distance_sqd < -1e-5:
                raise ValueError('They want to take the square root of the negative number!')
            d_lambda.append(0)
        # ML - end
...
# ML: changed function name from "wrapper" to "km_default"
def km_default(X_mixture,X_component):                 
