...
nsym = 20
classifier = "lr"
method_list = ['sar-em', 'PUe', 'lbe','pglin', 'pusb', 'threshold', 'oracle']
...
method_list_mod[method_list_mod.index('PUe')]=r'\textsc{PUe}'
...
for label_strat in ['S1', 'S2', 'S3', 'S4']:
    ...
    name_fig = 'plots_results_artificial/plot_label_strat' + label_strat + '.pdf'
    ...
    for j in range(3):
        ...
        axs[j].set_yticks([0, 1, 2, 3, 4, 5, 6])
